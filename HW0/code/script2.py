...
# Read the image
im = imageio.imread('HW0/data/mug.jpg')
...
plt.savefig('HW0/results/transformed_soln.jpg')
plt.show()

output = warpA.warp(im_gray, A, output_shape)
axes[1, 1].imshow(output, cmap=plt.get_cmap('gray'))
axes[1, 1].set_title('output')

plt.savefig('HW0/results/transformed.jpg')
plt.show()